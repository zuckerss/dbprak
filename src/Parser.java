	...
	if(curCity.isCapital)
      ...
      if (rawName.equals("inhabitants")) {
        try {
          ...
          System.err.println("ERR: Falscher Wert f�r inhabitants (" +
      ...
      if (rawName.equals("inhabitantsRegion")) {
        try {
          ...
          System.err.println("ERR: Falscher Wert f�r inhabitantsRegion (" +
                             curCountry.name + ", " + curCity.name +
                             ", " + elementText + ")\n" + e.getMessage());
        }
        return;
      ...
      if (rawName.equals("latitude")) {
        try {
          ...
          System.err.println("ERR: Falscher Wert f�r Breite (" +
                             curCountry.name + ", " + curCity.name +
                             ", " + elementText + ")\n" + e.getMessage());
        }
        return;
      ...
      if (rawName.equals("longitude")) {
        try {
          ...
          System.err.println("ERR: Falscher Wert f�r L�nge (" +
                             curCountry.name + ", " + curCity.name +
                             ", " + elementText + ")\n" + e.getMessage());
        }
        return;
